 ...
 */
public class ConnectPeersReceiver extends BroadcastReceiver {
    public static final String TAG = ConnectPeersReceiver.class.getSimpleName();

    public static final String  KEY_CONNECTED_PEERS = "KEY_CONNECTED_PEERS";

    /**
     * ArrayList of connected peers.
     */
